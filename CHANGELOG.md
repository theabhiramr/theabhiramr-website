...
- updated the social media icons and bottom navbar
- added new resume
...
- Switched from Formspree to Web3forms
...
- Replaced Outfit with Geist Sans and changed fonts
- Added a system setting for theme toggle
- Removed carousels and other unnecessary features

## v1.0

- Completely redesigned website using Tailwind and React
- Added pages for Work Experience, Projects and Resume
- Added carousel and timeline components to more stylistically display projects and work experience
